...
public class VisitorSwipe extends Swipe {
    ...
    public String toString(char delimiter){
        return EOLN + Integer.toString(this.id)+ delimiter + QUOTE + this.cardId + QUOTE + delimiter
                + QUOTE + this.room + QUOTE + delimiter + QUOTE + formatSwipeDateTime(this.swipeDateTime) 
                + QUOTE + delimiter + QUOTE + this.visitorName + QUOTE + delimiter + QUOTE + this.visitorCompany + QUOTE;
    }
        //any other way to write this method 
