...
public class Swipe {
   ...
   public void setCardId (String myCardId){
    ...
    /**
     * return 0 if objects compared are equal
     * return 1 if objects compared are not equal
     * throws a null exception pointer if null object is passed as a parameter.
     * @param compareSwipe 
    * @return 
     */
    
    public int compareTo(Swipe compareSwipe){
        int compared = compareSwipe.getId();
        if(this.getSwipeDateTime() == compareSwipe.getSwipeDateTime()) return 0;
        if(this.getSwipeDateTime() != compareSwipe.getSwipeDateTime()) return 1;
        return compared;
        // is there a way to make this if else statement 
    }
